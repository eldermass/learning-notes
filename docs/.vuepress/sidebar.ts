export default [
    ...
    },
    {
        ...
        text: "协议",
        link: "/协议/OAUTH2.md",
        children: ["/协议/OAUTH2.md"],
    },
    {
        collapsible: true,
        text: "规范",
        link: "/规范/RESTFULAPI.md",
        children: ["/规范/RESTFULAPI.md", "/规范/PromiseA+.md", "/规范/前端项目强制规范.md"],
    },
    {
        collapsible: true,
        text: "计算机基础",
        link: "/计算机基础/位运算.md",
        children: ["/计算机基础/位运算.md", "/计算机基础/base64原理.md", "/计算机基础/internet五层协议.md"],
    },
    {
        collapsible: true,
        text: "机器学习",
        link: "/机器学习/人工智障.md",
        children: ["/机器学习/人工智障.md"],
    },
    {
        collapsible: true,
        text: "JavaScript",
    ...
    },
    {
        ...
        text: "Node",
        link: "/node/Koa 解析.md",
        children: ["/node/Koa 解析.md", "/node/socket.md", "/node/文件操作.md", "/node/可执行命令.md"],
    },
    {
        collapsible: true,
        text: "PHP",
        link: "/php/laravel入门.md",
        children: ["/php/laravel入门.md", "/php/laravel续.md"],
    },
    {
        collapsible: true,
        text: "Python",
    ...
    },
    {
        ...
        text: "Golang",
        link: "/go/golang基础.md",
        children: ["/go/golang基础.md", "/go/区块链与go.md", "/go/beego.md", "/go/gin.md"],
    },
    {
        collapsible: true,
        text: "数据库",
        link: "/数据库/redis入门.md",
        children: ["/数据库/redis入门.md", "/数据库/mysql入门.md", "/数据库/mongoDB入门.md"],
    },
    {
        collapsible: true,
        text: "其他",
        link: "/其他/gojs 去水印.md",
        children: ["/其他/gojs 去水印.md"],
    },
]
